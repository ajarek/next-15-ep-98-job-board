        ...
        <section className="py-16 md:py-32">
            <div className="mx-auto max-w-7xl px-6">
                <div className="mx-auto max-w-2xl space-y-6 text-center">
                    ...
                    <p>The job posting here ensures a large influx of suitable offers, candidates with high qualifications and relevant experience. Choose the right financial plan for you.</p>
                </div>
